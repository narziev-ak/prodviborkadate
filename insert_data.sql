...
VALUES
    ...
    -- Тестовые треки для проверки задания 2.5 (должны попасть в выборку)
    ('my own', 180, 2),
    ('own my', 180, 2),
    ('my', 180, 2),
    ('oh my god', 180, 2),

    -- Тестовые треки для проверки задания 2.5 (НЕ должны попасть в выборку)
    ('myself', 180, 2),
    ('by myself', 180, 2),
    ('bemy self', 180, 2),
    ('myself by', 180, 2),
...
VALUES
    ...
    (4, 10, 4),
    (4, 11, 5),
    -- My Heart Will Go On (track_id = 11)
